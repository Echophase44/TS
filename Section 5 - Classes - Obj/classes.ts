...
abstract class Warrior {
    ...
    abstract printName(this: Warrior): void;
}
// Any class extended from this one has to include a printName method and implement it's own conditions.


/////////////////////////////SINGLETON PATTERN //////////////////////

class Ruler {
  private static instance: Ruler;
  ...
  static getInstance(){
    ...
    return this.instance = new Ruler("Default")
  }
}

// this only allows one instance of a class to exsist.